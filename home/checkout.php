                    ...
                    <div class="checkout-sidebar">
                        <div class="sidebar-widget checkout-sidebar py-6 px-4 bg-white rounded-2">
                            ...
                            <button type="submit" name="placeorderbtn" class="btn btn-primary btn-md rounded mt-6 w-100"
                                <?php echo count($addresses) == 0 || $count == 0 ? 'disabled' : ''; ?>>Place
                                Order</button>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="label-input-field">
                                        ...
                                        <input type="text" placeholder="Apart Number" name="aptnumber">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="label-input-field">
                                ...
                                <div class="col-sm-4">
                                    <div class="label-input-field">
                                        ...
                                        <input type="text" placeholder="Dhaka-1230" name="zipcode">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-6 d-flex">
                                <button type="submit" class="btn btn-secondary btn-md me-3" name="addaddressbtn">Use
                                    this Address</button>
                                <button type="submit"
