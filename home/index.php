...
<section class="gshop-hero pt-120 bg-white position-relative z-1 overflow-hidden">
    ...
    <img src="../assets/img/shapes/mango.png" alt="mango" class="position-absolute mango z--1" data-parallax='{"y": -120}'>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-5 col-lg-8">
                            <div class="hero-left-content">
                                <span class="gshop-subtitle fs-5 text-secondary mb-2 d-block">Purely Sweet, Purely Organic</span>
                                <h1 class="display-4 mb-3">Freshly <mark class="p-0 bg-transparent text-secondary">Made Sweets</mark> Online</h1>
                                ...
                                <div class="hero-btns d-flex align-items-center gap-3 gap-sm-5 flex-wrap">
                                    ...
                                    <a href="about.html" class="btn btn-primary">About Us<span class="ms-2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide gshop-hero-single">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-5 col-lg-8">
                            <div class="hero-left-content">
                                <span class="gshop-subtitle fs-5 text-secondary mb-2 d-block">From Nature to Your Plate</span>
                                <h1 class="display-4 mb-3">Discover the <mark class="p-0 bg-transparent text-secondary">Authentic Taste of 100%</mark> Organic Sweets.</h1>
                                <p class="mb-7 fs-6">Assertively target market-driven intellectual capital with worldwide human capital holistic.</p>
                                <div class="hero-btns d-flex align-items-center gap-3 gap-sm-5 flex-wrap">
                                    <a href="shop-grid.html" class="btn btn-secondary">Shop Now<span class="ms-2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <a href="about.html" class="btn btn-primary">About Us<span class="ms-2"><i class="fa-solid fa-arrow-right"></i></span></a>
                ...
                <div class="swiper-slide gshop-hero-single">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-xl-5 col-lg-8">
                            <div class="hero-left-content">
                                <span class="gshop-subtitle fs-5 text-secondary mb-2 d-block">Your Sweet Cravings, Freshly Crafted and Delivered Online.</span>
                                <h1 class="display-4 mb-3">Freshly <mark class="p-0 bg-transparent text-secondary">Made Sweets</mark> Online</h1>
                                <p class="mb-7 fs-6">Assertively target market-driven intellectual capital with worldwide human capital holistic.</p>
                                <div class="hero-btns d-flex align-items-center gap-3 gap-sm-5 flex-wrap">
                                    <a href="shop-grid.html" class="btn btn-secondary">Shop Now<span class="ms-2"><i class="fa-solid fa-arrow-right"></i></span></a>
...
<section class="banner-section position-relative z-1 overflow-hidden pt-120 pb-200">
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-xl-8">
                <div class="banner-box background-banner rounded-2 banner-lg" data-background="../assets/img/banner/banner-2.jpg">
                    <span class="badge bg-danger mb-2">Top Offer</span>
                    <h3 class="mb-6 text-white gshop-title">Fresh & Natural Healthy<br class="d-none d-sm-block"> Food <mark class="position-relative text-secondary position-relative bg-transparent">Special Offer<img src="../assets/img/shapes/border-line.png" class="position-absolute start-0 border-line w-100" alt="border line"></mark></h3>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6">
                <div class="section-title text-center mb-4">
                    ...
                    <p class="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique a eligendi reiciendis ipsam error</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 mb-4">
                    <div class="horizontal-product-card d-sm-flex align-items-center p-3 bg-white rounded-2 gap-4">
                        ...
                        <div class="card-content mt-4 mt-sm-0">
                            ...
                            <a href="product-details.html" class="fw-bold text-heading title d-block"><?= $category['catname']?></a>
...
<section class="pt-8 pb-100 bg-white position-relative overflow-hidden z-1 trending-products-area">
    <img src="../assets/img/shapes/garlic.png" alt="garlic" class="position-absolute garlic z--1" data-parallax='{"y": 100}'>
    <img src="../assets/img/shapes/carrot.png" alt="carrot" class="position-absolute carrot z--1" data-parallax='{"y": -100}'>
    <img src="../assets/img/shapes/mashrom.png" alt="mashrom" class="position-absolute mashrom z--1" data-parallax='{"x": 100}'>
    <div class="container">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10 filter_item">
                <div class="vertical-product-card rounded-2 position-relative">
                    <div class="thumbnail position-relative text-center p-4">
                        <a href="product-details.html"><img src="../assets/img/products/<?= $product['product_image']?>" alt="apple" class="img-fluid"></a>
                    ...
                    <div class="card-content">
                        <a href="shop-grid.html" class="mb-2 d-inline-block text-secondary fw-semibold fs-xxs">Fresh Organic</a>
                        <a href="product-details.html" class="card-title fw-bold d-block mb-2"><?=$product['product_name'] ?></a>
    ...
    <div class="container">
        <div class="row align-items-center g-4 justify-content-center">
            <div class="col-xl-4 col-md-6">
                <div class="banner-box background-banner rounded-2 overflow-hidden" data-background="../assets/img/banner/banner-1.jpg">
        ...
        <div class="row g-4 align-items-center justify-content-center">
            <div class="col-xxl-4 col-xl-5 order-2 order-xxl-1">
                <div class="banner-box banner-color-green position-relative overflow-hidden z-1 rounded-2 pe-0 pb-0">
                    ...
                    <a href="product-details.html" class="btn btn-primary btn-md">Show Now<span class="ms-2"><i class="fas fa-arrow-right"></i></span></a>
                ...
                <div class="mt-4">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="horizontal-product-card d-sm-flex align-items-center p-3 bg-white rounded-2 shadow gap-4">
                                <div class="thumbnail position-relative rounded-2">
                                    <a href="product-details.html"><img src="../assets/img/products/p-sm-3.png" alt="product" class="img-fluid"></a>
                                    <div class="product-overlay position-absolute start-0 top-0 w-100 h-100 d-flex align-items-center justify-content-center gap-2 rounded-2">
                                        <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                        <a href="#quickview_modal" data-bs-toggle="modal" class="rounded-btn"><i class="fa-solid fa-eye"></i></a>
                                        <a href="#" class="rounded-btn">
                    ...
                    <div class="swiper gshop-feedback-slider mt-4">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide feedback-single text-center">
                                <p class="mb-5">“The rasgullas here are a slice of heaven! Each bite melts in your mouth. I ordered a customized cake for my daughter's birthday, and it was not just beautiful but also incredibly delicious. This is my go-to place for every celebration now!” </p>
                            ...
                            <div class="swiper-slide feedback-single text-center">
                                <p class="mb-5">“I tried their kaju katli and gulab jamun, and they were simply perfect! Fresh, flavorful, and the sweetness level was just right. The staff is very friendly and accommodating. Highly recommended!” </p>
                            ...
                            <div class="swiper-slide feedback-single text-center">
                                <p class="mb-5">“I ordered a butterscotch cake for my parents' anniversary, and it was beyond my expectations! The presentation was stunning, and the taste was divine. Everyone at the party loved it!” </p>
                            ...
                            <div class="swiper-slide feedback-single text-center">
                                <p class="mb-5">“Their laddoos and barfis reminded me of my grandmother's recipes. Authentic flavors, excellent quality, and reasonable prices. It's a hidden gem for sweet lovers!” </p>
