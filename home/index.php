                    ...
                    <div class="row justify-content-center g-4">
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="gshop-animated-iconbox py-5 px-4 text-center border rounded-3 position-relative overflow-hidden">
                                ...
                                <a href="javascript:void(0);" class="text-dark fs-sm fw-bold d-block mt-3">Custom cake orders</a>
                            </div>
                        </div>
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="gshop-animated-iconbox py-5 px-4 text-center border rounded-3 position-relative overflow-hidden color-2">
                                ...
                                <a href="javascript:void(0);" class="text-dark fs-sm fw-bold d-block mt-3">Ready-to-sell cakes and pastries</a>
                            </div>
                        </div>
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="gshop-animated-iconbox py-5 px-4 text-center border rounded-3 position-relative overflow-hidden color-3">
                                ...
                                <a href="javascript:void(0);" class="text-dark fs-sm fw-bold d-block mt-3">Delivery services (same-day or scheduled).</a>
                            </div>
                        </div>
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="gshop-animated-iconbox py-5 px-4 text-center border rounded-3 position-relative overflow-hidden color-4">
                                ...
                                <a href="javascript:void(0);" class="text-dark fs-sm fw-bold d-block mt-3">Occasion-specific offerings (festivals, events).
                                </a>
                            </div>
                        </div>
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="gshop-animated-iconbox py-5 px-4 text-center border rounded-3 position-relative overflow-hidden color-5">
                                ...
                                <a href="javascript:void(0);" class="text-dark fs-sm fw-bold d-block mt-3">Gift packaging and hampers.
                                </a>
                            </div>
                        </div>
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="gshop-animated-iconbox py-5 px-4 text-center border rounded-3 position-relative overflow-hidden color-3">
                                ...
                                <a href="javascript:void(0);" class="text-dark fs-sm fw-bold d-block mt-3">Catering for parties and events.
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center g-4 mt-5 filter_group">
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10 filter_item">
                        <div class="vertical-product-card rounded-2 position-relative">
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="product-details.html"><img src="assets/img/products/apple.png" alt="apple" class="img-fluid"></a>
                            ...
                            <div class="card-content">
                                ...
                                <a href="product-details.html" class="card-title fw-bold d-block mb-2">Popped Rice Crisps Snacks Chocolate.</a>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10 filter_item sea_food">
                        <div class="vertical-product-card rounded-2 position-relative">
                            ...
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="product-details.html"><img src="assets/img/products/apple-black.png" alt="apple" class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                                        <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10 filter_item vegetables">
                        <div class="vertical-product-card rounded-2 position-relative">
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="product-details.html"><img src="assets/img/products/pinut.png" alt="apple" class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                                        <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6 col-sm-10 filter_item beans_peas">
                        <div class="vertical-product-card rounded-2 position-relative">
                            <span class="offer-badge text-white fw-bold fs-xxs bg-danger position-absolute start-0 top-0">-12% OFF</span>
                            <div class="thumbnail position-relative text-center p-4">
                                <a href="product-details.html"><img src="assets/img/products/stroberry.png" alt="apple" class="img-fluid"></a>
                                <div class="product-btns position-absolute d-flex gap-2 flex-column">
                                    <a href="#" class="rounded-btn"><i class="fa-regular fa-heart"></i></a>
                                    <a href="#" class="rounded-btn">
                                        <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
